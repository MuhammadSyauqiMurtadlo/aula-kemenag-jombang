...
check_role([1]);
$page_title = 'Histori Penggunaan Aula';

// Ambil histori
$query = "SELECT h.*, a.nama_aula, s.nama_seksi, p.kode_pengajuan, p.nama_pemohon
          FROM histori_penggunaan h
          LEFT JOIN aula a ON h.aula_id = a.id
          LEFT JOIN seksi s ON h.seksi_id = s.id
...
<div class="card">
    <div class="card-header">
        <h3>Histori Penggunaan Aula</h3>
    </div>

    <div class="card-body">
        <?php if (mysqli_num_rows($result) == 0): ?>
        <div class="alert alert-info">Belum ada histori penggunaan</div>
        <?php else: ?>
